...
import charlesPortrait from "../assets/charles_portrait1.jpeg";
import johnnyPortrait from "../assets/johnny_portrait1.jpg";
    ...
    <Layout>
      ...
      <Section subhead="JOHNNY O’HARA" id="johnny">
        ...
        <p>
          ...
          <br />
          <br />
          The KENSU MARU documentary has a compelling protagonist in pursuit of
          a high stakes goal striving against formidable obstacles in a race
          against the clock. Chuck McDougald is an exceptional main character.
          There’s a reason he’s been so often referred to as a “real life
          Indiana Jones”. This warrior poet has led a life full of both
          adventure and academia. Although he was trained as an elite soldier it
          was his pen not his sword that helped bring down a dictator.
          <br />
          <br />
          He’s motivated not by the opportunity to gain a fortune, he’s
          motivated by the need to solve a mystery and seek justice. At
          80-years-old he may not have much time to do it. He’s a former Green
          Beret on what might be his last and most important mission.
          <br />
          <br />
          ...
          <br />
          <br />
          But there’s another motivation for both of these men that elevates
          this from a simple treasure hunt. They both have plans to use the
          treasure as a force for good. There are several environmental and
          humanitarian initiatives that will be funded by the treasure when
          found. Most of the films I’ve worked on in the past had as their goal
          to try and make the world a better place by raising awareness of
          global problems and promoting ways to solve them. This film is no
          exception.
          <br />
          <br />
          The KENSU MARU documentary will have a wide audience. It’s a hybrid of
          several genres. It’s an adventure story, a mystery story, a war story,
          a history story, a character portrait, a thriller, and ultimately an
          environmental activism story. Television is filled with successful and
          popular treasure hunt series. In fact, John Casey is one of the stars
          of such a show, LOST GOLD OF WWII, a highly rated series on The
          History Channel that also focuses on the search for Yamashita’s Gold
          in the Philippines. But there is an audience beyond that demographic.
          <br />
          <br />
          The television versions of treasure hunts tell the story using the
          tropes of Reality TV. I see the KENSU MARU documentary told more in
          the style of a Sundance/Cannes caliber film. It will have all the fun
          and suspense that make treasure hunting stories so appealing but it
          will have much more. The treasure hunt story is a trojan horse to
          touch on universal themes like ambition, greed, mortality, redemption
          and justice.
          <br />
          <br />
          ...
          <br />
          <br />
          The film will be told in a mix of styles. The present day treasure
          hunt expedition will be told in verité style as shot by our expert
          cinematographers. Much of the rest of the film will be a “clip show”
          of archival footage of WWII history, the Marcos regime, and the
          Vietnam era. I’m very happy again to be collaborating with Pamela
          Green of Pic Agency and her new archival specialty shop LEGWORK, to
          create these archival footage segments in original and innovative
          ways. My film BHUTTO won an IDA award for best use of archival
          material with work we created together.
          <br />
          <br />
          The history that KENSU MARU will be telling in this story will have
          relevance to what is happening today. Part of the KENSU MARU
          documentary is a cautionary tale of how in a few short years a
          democracy can transform into an autocracy. Ferdinand Marcos was a
          democratically elected official who became a dictator through bribery,
          brutality and repression. Our experience with the fragility of our own
          democracy makes the Marcos story particularly timely.
          <br />
          <br />
